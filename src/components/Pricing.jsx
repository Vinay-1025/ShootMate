            ...
            <div className='text-center'>
                ...
                <div className='mt-16'>
                    <label htmlFor='toggle' className='inline-flex items-center cursor-pointer'>
                        ...
                        <div className='w-14 h-6 bg-gray-300 rounded-full relative'>
                            <div 
                                className={`w-6 h-6 rounded-full absolute top-0 transform transition-all duration-300 ${isYearly ? 'bg-primary translate-x-8' : 'bg-gray-500'}`}
                            ></div>
                        </div>
